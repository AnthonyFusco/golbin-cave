...
(deftest entity-resolver-test
  (testing "get existing entity from env"
    (let [id 0
          entities (entity/entities-resolver mock/test-env mock/mock-world)
...
(deftest entities-resolver-test
  (testing "get all entities from world"
    (let [entities (entity/entities-resolver mock/test-env mock/mock-world)]
...
(deftest location-mutation-test
  (testing "changes location with update-entity-fn!"
    (let [world-atom (atom mock/world-value)
          env (assoc mock/test-env :world-atom world-atom)
          new-location 6
          _ (p.eql/process
  ...
  (testing "changes location with update-entity-location!"
    (let [world-atom (atom mock/world-value)
          env (assoc mock/test-env :world-atom world-atom)
          new-location 6
          _ (p.eql/process
